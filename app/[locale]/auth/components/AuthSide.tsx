  ...
  return (
    <div className="relative flex-1 overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        <div className="absolute end-32 start-32 top-32 flex h-52 flex-col gap-2 rounded-lg bg-white/40 px-5 py-5 backdrop-blur-sm">
          <h2 className="text-2xl font-semibold text-neutral-900">
            Not translated text ....
          </h2>
          <p className="text-neutral-600">This is some dummy text</p>
        </div>
